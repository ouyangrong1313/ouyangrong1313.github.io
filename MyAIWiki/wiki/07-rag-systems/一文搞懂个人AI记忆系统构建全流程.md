...
tags:
  ...
  - 主题/跨工具协作
  - 场景/公众号长文
nodes: [工具无关记忆库, 五层记忆, 两级目录, 目录权重, 七字段元数据, 双层索引, 按需召回, 确认式写入]
links: [[07-rag-systems/如何构建一个更好的知识库]], [[01-ai-agents/若飞-Agent-记忆与可验证自我改进怎么设计]], [[01-ai-agents/llm-agent-unified-memory-framework]], [[01-ai-agents/how-to-build-personal-ai-system-with-claude]]
date: 2026-08-27
source: 微信公众号「腾讯云开发者」
---
