...
tags:
  ...
  - 主题/知识工程
  - 场景/企业研发
nodes: [全链路PDCA, TPRD-Contract, 环境护栏, UTD闭环, AI评测员, 三层知识, Highway, ATV进化]
links:
...
date: 2026-08-26
source: 微信公众号「AICon」整理白忠魏（得物推荐）演讲
---
...
1. **Plan**：TPRD/Contract 规定要改哪里、不能破什么约束、怎样证明成功；人工在技术方案阶段做关键 Review。
2. **Do**：沙箱隔离、外部依赖 Mock 和 UTD 使 Agent 能修改、运行、读取日志并根据结果修正。
3. **Check**：除稳定性外，用画像化 AI 评审员检验推荐的新颖性、质量与用户兴趣，专家对过程抽样复核。
4. **Act**：线上 Bad Case 的排查路径不只留下说明，而是转成可执行 Story；已知问题走 Highway，未知问题走 ATV 后再沉淀。
