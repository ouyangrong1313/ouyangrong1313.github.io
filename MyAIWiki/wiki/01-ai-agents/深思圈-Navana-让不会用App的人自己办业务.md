---
title: 深思圈：让不会用 App 的人自己办业务，Navana 语音 AI 案例
...
tags:
  ...
  - 场景/公众号长文
  - 场景/Seetong借鉴
nodes: [任务完成率, 多模态引导, 有限对话, 真实业务验证, 首次使用教学, 语音识别边界, 伙伴交付, 双用户上下文, 语音闭环]
links: [[01-ai-agents/源泉TheFountainhead-从GUI到AI-Native-产品接目标界面换职责]], [[01-ai-agents/字节跳动质量保障团队-测试用例生成Agent落地-我们做对了什么]], [[01-ai-agents/Agent评测漫谈-由浅入深讲解Agent评测]], [[01-ai-agents/腾讯-AI-Agent-Skill-测评方案落地]]
date: 2026-09-09
source: 微信公众号「深思圈」/ 深思 SenseAI；原文基于 Navana.ai、Ujjivan、ThePrint 等公开材料
---
...
- 发布日期：2026-09-08
- 获取时间：2026-09-09
- 原文归档：[完整正文](../../raw/深思圈-Navana-让不会用App的人自己办业务.md)
