...
tags:
  ...
  - 主题/奖励黑客
  - 场景/公众号长文
nodes: [RSI四层判据, 持久改进, 自主闭环, 递归增益, 奖励黑客, Harness自改进, 训练环境闭环, 外部验证边界]
links: [[01-ai-agents/Lilian-Weng-Harness-Engineering-自我改进]], [[01-ai-agents/一篇讲透Agent自进化飞轮怎么搭-评测→记忆→落地→控制]], [[01-ai-agents/Loop-Engineering-验证才是瓶颈]], [[01-ai-agents/清华沈阳-自进化AI新物种]], [[01-ai-agents/Agent评测漫谈-由浅入深讲解Agent评测]], [[01-ai-agents/若飞-Agent-记忆与可验证自我改进怎么设计]]
date: 2026-09-20
source: 微信公众号 / Datawhale（赵志民）
status: published
---
