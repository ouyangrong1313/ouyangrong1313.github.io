...
links: ["[[01-ai-agents/2026-07-29-人月聊IT-通用AI-Agent平台-Harness技术底座]]", "[[01-ai-agents/储旭-从Prompt到Harness-企业级Agent工程的完整演进之路]]", "[[01-ai-agents/WorkBuddy-Harness工程复盘-从模型到可用Agent]]"]
date: 2026-07-30
...
- [[01-ai-agents/储旭-从Prompt到Harness-企业级Agent工程的完整演进之路]]：Agent OS 的演进框架。
- [[01-ai-agents/WorkBuddy-Harness工程复盘-从模型到可用Agent]]：Context、Memory、Skill、MCP 的产品层解释。
- [[01-ai-agents/若飞-Agent-记忆与可验证自我改进怎么设计]]：记忆的准入、失效和晋升治理。
