...
tags:
  ...
  - 主题/持续改进
  - 场景/公众号长文
nodes: [可信上下文, 信任结构, 责任单元, 显式编排, 异步审阅, 任务回写, 改进闭环]
links: [[01-ai-agents/Multica-AI-Native-组织-人是最慢的节点]], [[01-ai-agents/腾讯程序员-Agent的上限可能不在模型而在团队知识]], [[01-ai-agents/若飞-Agent-记忆与可验证自我改进怎么设计]], [[01-ai-agents/Loop-Engineering-验证才是瓶颈]]
date: 2026-08-28
source: 微信公众号 Founder Park / Moxt 团队
---
