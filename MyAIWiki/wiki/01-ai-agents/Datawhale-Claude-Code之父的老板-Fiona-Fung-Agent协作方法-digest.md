...
tags: [#主题/AI-Agent, #主题/AI-Coding, #场景/公众号长文, #节点/Agent-Loop, #节点/Claude-Code]
date: 2026-07-06
...
### 上游（基于 / 来自）
- [[loonggg-Claude-Code-技能心法-11条建议]]：Claude Code 团队内部使用 Skills 的经验——本文"spec 入仓 + Claude code review"是从 Skill 心法到协作方法论的延伸
