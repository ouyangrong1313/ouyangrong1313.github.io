...
- **原文链接**：https://mp.weixin.qq.com/s/a_kmAg0XM0SKNpVev_ePyA
- **一手来源**：Greg Isenberg Startup Ideas Podcast "AI Agents are the new SaaS"  https://www.youtube.com/watch?v=83fWzQSWB10
- **作者**：Greg Isenberg（硅谷 Startup Ideas Podcast 主理人 + Late Checkout 创始人 + 前 Reddit 战略）
- **公众号**：「Capihom」（晚点再听LaterCast 同主线第 N 篇编译）
- **分类理由**：本文是"AI Agent 商业模式 + 产品方向"主线（区别于工程方法论）；同 Capihom 编译主线 5 篇（Groupon / Avoca / Codex / Multica / OpenClaw）放 01-ai-agents
- **获取时间**：2026-07-08 10:50
...
- **场景**：AI 产品方向 / SaaS 转型 / 商业模式
- **类型**：Agent **商业化方向**（区别于：阿里/腾讯/字节 Harness 工程派 / 翁荔 Harness 学术原典派 / Fiona Anthropic 团队派 / Multica 极端样本派）
- **关键定位**：Greg 是硅谷 AI 创业评论员，给"如何找 Agent 产品方向 + 如何落地试点"完整决策树
...
- **原视频已确认**：https://www.youtube.com/watch?v=83fWzQSWB10（30+ 分钟，Greg 完整版讲解）
- **Greg Isenberg 角色定位**：硅谷创业评论员 + Late Checkout 创始人，前 Reddit 战略；视角偏"硅谷 AI 创业方法论"
- **Capihom 编译立场**：公众号定位"晚点再听LaterCast"，专注硅谷 AI 创业播客总结；本文是同主线第 N 篇编译
- **价格锚点为美国市场**：1500/2000/3000 美元/月不直接适用于中国市场，但"设置费 + 月费 + 单价 + 票数"模式可参考
- **30 天计划假定有 AI 编程能力**：第 5/6 天"用 Claude/ChatGPT 手工跑"+"做最小版本"对非开发者是难点
