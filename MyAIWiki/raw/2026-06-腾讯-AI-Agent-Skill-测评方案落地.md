...
slug: 腾讯-AI-Agent-Skill-测评方案落地
date: 2026-06-17
obtain_date: 2026-06-17
author_team: TEG 云架构平台部 网关测试团队
author_lead: martinskxu
source: 微信公众号 腾讯程序员
source_url: https://mp.weixin.qq.com/s/PUbGqheJhFMmb6hGj1ZtOw
project: TPerf 性能平台智能分析 Agent
extraction: 微信 HTML 抽取 (id="js_content" 区段) ;清洗:去除头部字段/导语/表格符号/残段 HTML
word_count_chars: 14487
paragraphs: 675
...
> 原始来源:微信公众号 腾讯程序员,作者 TEG 云架构平台部 网关测试团队(martinskxu),发布于 2026-06-17。
> 原文链接:https://mp.weixin.qq.com/s/PUbGqheJhFMmb6hGj1ZtOw
> 导语:当 AI Agent 从"Demo 可用"走向"生产可靠",测评就是那道必须跨过的门槛。本文介绍了 TEG 云架构平台部网关测试团队在 AI Agent 测评领域的体系化实践,面对 Agent 非确定性、黑盒化、错误级联放大三大难题,建立了一套"确定性评分器 + Rubric 评分器 + 人工评分器"三类组合的完整测评框架,覆盖功能正确性、过程质量、效率成本、鲁棒性安全、体验对齐五大维度,并已在 TPerf 性能平台智能分析 Agent 项目中落地验证。
...
- 本次抓取清洗范围:id="js_content" 区段所有可读文本(去标签 + 去空白行)
- 已去除:头部字段(id="js_content" 标签、作者、导语)、表格符号(✗/✓)、残段 HTML 标签
- 未展开:正文中的表格(已转纯文本行)、配图、所有引用 blockquote
- 段落编号:1-675 段,共 14487 字符
- 标签:#主题/AI-Agent #主题/Agent测评 #主题/Skill测评 #主题/Agent工程化 #主题/腾讯工程实践 #节点/三类评分器 #节点/五大维度 #节点/用例基线 #节点/结构化Trace #节点/稳定性评估 #节点/负向触发用例 #手法/反例论证 #手法/工程框架 #手法/基线对比 #场景/Agent工程化 #场景/Skill设计
