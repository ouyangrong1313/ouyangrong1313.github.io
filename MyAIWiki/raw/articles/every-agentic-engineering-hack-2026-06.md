...
**来源：** X (Twitter) — Matt Van Horn @mvanhorn
**作者：** Matt Van Horn（@mvanhorn）
**日期：** 2026年6月3日 上午2:28
**链接：** https://x.com/mvanhorn/status/2061877533885473181
**互动数据：** 80 评论 · 214 转推 · 1,669 喜欢 · 5,144 书签 · 34万 浏览
**系列：** 3 月前发过 "Every Claude Code Hack I Know"（91.3万 浏览）后的 6 月升级版
...
### The YOLO TL;DR Hack
> paste this entire article to your agent and tell it to make a plan to set up everything in it, then work that plan one hack at a time. That's my whole stack, no reading required.
...
Compound Engineering, from @kieranklaassen and @trevin is the plugin that makes it real. I became a superfan, then a contributor, now I'm the 3rd biggest contributor behind the core team. My rule now: unless it is literally a one-line change, there is always a plan.md first.
...
Set remote control to turn on automatically for every session. Now every window is reachable from the Claude mobile app. Start a session at your desk, walk away, pick up the exact same live run on your phone mid-task. In a line somewhere, you're steering what's churning away on your Mac at home.
...
- Give Claude an email. Paste to your agent: "Give Claude Code an email address using github.com/mvanhorn/agentmail-to-claude-code..."
...
The other setting is a **sound hook**, non-negotiable with six sessions. Walk away, come back when you hear it. With six sessions running, the sound is how you know which one just finished.
...
This is also most of my open source life now. If you look at my GitHub, the work is skills and the tools around them. last30days started as a skill I wanted for myself and is now open source past 26K stars. Printing Press is a whole factory for generating agent-native CLIs, with over 320 merged PRs into it. I'm one of the top contributors to Compound Engineering itself. **None of it was a grand plan. Each piece was a workflow I ran often enough that it was worth making the agent permanently good at it.**
...
- **Add value on X** — On X Pay $1-3/month to subscribe to people you respect. I pay $1/month to @garrytan and when I submit a PR I can send an X post to him and he gets a special notification that I'm a paying customer.
